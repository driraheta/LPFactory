...
{
    [Authorize]
    public class ArticuloFamiliasController : Controller
    {
        private readonly ApplicationDbContext _context;
        private UserManager<ApplicationUser> _userManager;

        public ArticuloFamiliasController(ApplicationDbContext context, UserManager<ApplicationUser> userManager)
        {
            _context = context;
        ...
        private static object MapToGridModel(ArticuloFamilia x)
        {
            return
                new
                {
            ...
            string codigo, string descripcion)
        {
            ...
            var query = _context.ArticuloFamilias
            ...
            var enviar = new GridModelBuilder<LPFactory.Data.ArticuloFamilia>(query, g)
            {
                KeyProp = x => x.Id,// needed for Entity Framework | nesting | tree | api
                GetItem = () => _context.ArticuloFamilias                    
        ...
        [HttpPost]
        public async Task<IActionResult> Create(ArticuloFamilia input)
        {
        ...
        public async Task<IActionResult> Edit(int id)
        {
            ...
            var entidad = await _context.ArticuloFamilias                
        ...
        public async Task<IActionResult> Edit(ArticuloFamilia input)
        {
