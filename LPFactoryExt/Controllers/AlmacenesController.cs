...
namespace LPFactory.Controllers
{
    ...
    public class AlmacenesController : Controller
    {
        ...
        public AlmacenesController(ApplicationDbContext context, UserManager<ApplicationUser> userManager)
        {
            _context = context;
        ...
        private static object MapToGridModel(Almacen x)
        {
            return
                new
                {
            ...
            string codigo, string descripcion)
        {
            ...
            var enviar = new GridModelBuilder<LPFactory.Data.Almacen>(query, g)
            {
                KeyProp = x => x.Id,// needed for Entity Framework | nesting | tree | api
                GetItem = () => _context.Almacenes                    
        ...
        [HttpPost]
        public async Task<IActionResult> Create(Almacen input)
        {
        ...
        public async Task<IActionResult> Edit(int id)
        {
            ...
            var entidad = await _context.Almacenes
        ...
        public async Task<IActionResult> Edit(Almacen input)
        {
